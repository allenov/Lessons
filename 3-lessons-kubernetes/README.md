...
![Диаграмма взаимодействия компонентов Kubernetes](/3-lessons-kubernetes/images/image1.png)
...
![Диаграмма работы Service и Ingress](/3-lessons-kubernetes/images/image2.png)
...
Поле kind — это одно из полей в метаданных манифеста ресурса, которое определяет, к какому типу относится описываемый объект.\
...
![Labels](/3-lessons-kubernetes/images/image3.png)
